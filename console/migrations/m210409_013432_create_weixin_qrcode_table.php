...
/**
 * Handles the creation of table `{{%weixin_qrcode}}`.
 */
class m210409_013432_create_weixin_qrcode_table extends Migration
{

    public $table = '{{%weixin_qrcode}}';
    ...
    public function up()
    {
        ...
        $this->createTable($this->table, [
            ...
            'expires_in'  => $this->integer()->unsigned()->notNull()->comment('设置的过期时间'),
            'expires_at'  => $this->dateTime()->notNull()->comment('过期日期'),
